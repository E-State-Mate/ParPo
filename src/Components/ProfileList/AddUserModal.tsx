...
const AddUserModal: React.FunctionComponent<AddUserModalProps> = ({open, handleClose, isUserAdded}) => {
    ...
    <div>
        <Modal open={open} onClose={handleClose}>
            <Box sx={style}>
                ...
                {msg !== '' && <p style={{fontSize: '0.6rem', fontWeight: 'bold', textAlign: 'center'}}>{msg}</p>}
